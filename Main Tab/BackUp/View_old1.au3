...
Func MainTab_View()
	...
	_AutoItObject_AddMethod($this, "TabItem", "MainTab_View_TabItem", True)
	_AutoItObject_AddMethod($this, "Resize", "MainTab_View_Resize", True)
	_AutoItObject_AddMethod($this, "Hide", "MainTab_View_Hide", True)
	_AutoItObject_AddMethod($this, "Show", "MainTab_View_Show", True)
	_AutoItObject_AddMethod($this, "ShowCanvas", "MainTab_View_ShowCanvas", True)
	_AutoItObject_AddMethod($this, "ShowParameters", "MainTab_View_ShowParameters", True)
	_AutoItObject_AddMethod($this, "ShowScript", "MainTab_View_ShowScript", True)
	_AutoItObject_AddMethod($this, "ShowObjectExplorer", "MainTab_View_ShowObjectExplorer", True)
	_AutoItObject_AddMethod($this, "ShowSettings", "MainTab_View_ShowSettings", True)
...
Func MainTab_View_Create(ByRef $this)
	$this.Tab = CreateTab($this.Left, $this.Top, 350, 25)
...
Func MainTab_View_TabItem(ByRef $this, Const $title, Const $width, Const $height, Const $hwnd)
	Local Const $hwnd = GUICreate( _
			$title, _
			(($width - 100) * $DPIRatio), _
			(($height - 60) * $DPIRatio), _
			(90 * $DPIRatio), _
			(30 * $DPIRatio), _
			$WS_CHILD, _
...
Func MainTab_View_Resize(Const ByRef $this)
	Local Const $tabItems[] = [$this.CanvasHwnd, $this.ParametersHwnd, $this.ScriptHwnd, $this.ObjectExplorerHwnd, $this.SettingsHwnd]
