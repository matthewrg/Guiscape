...
Func MessageQueue_Push(ByRef $this, Const ByRef $sender, Const ByRef $message, Const $key1 = Null, Const $data1 = Null, Const $key2 = Null, Const $data2 = Null, Const $key3 = Null, Const $data3 = Null, Const $key4 = Null, Const $data4 = Null, Const $key5 = Null, Const $data5 = Null)
	Local Const $event = $this.CreateEvent($sender, $message, $key1, $data1, $key2, $data2, $key3, $data3, $key4, $data4, $key5, $data5)
	
	If $message = 0 Then Return True
	
	Print(VarGetType($message))
...
Func MessageQueue_CreateEvent(Const ByRef $this, Const ByRef $sender, Const ByRef $message, Const  $key1 = Null, Const  $data1 = Null, Const  $key2 = Null, Const  $data2 = Null, Const $key3 = Null, Const $data3 = Null, Const $key4 = Null, Const $data4 = Null, Const ByRef $key5 = Null, ByRef Const $data5 = Null)
	#forceref $this
