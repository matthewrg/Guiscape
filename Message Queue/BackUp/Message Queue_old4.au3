...
Func MessageQueue_Push(ByRef $this, Const $topic, Const $message)
	Local Const $message1 = $this.CreateMessage($topic, $message)
...
Func MessageQueue_CreateMessage(ByRef $this, Const $topic, Const $message)
	Local $messageMap[]
	...
	Return $messageMap
EndFunc   ;==>MessageQueue_Create_Message
