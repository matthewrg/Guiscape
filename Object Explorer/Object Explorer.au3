...
Func ObjectExplorer_Create(ByRef $this, Const ByRef $parent)
	$this.Hwnd = GUICreate("Object Explorer", ($parent.Width - 105) * $g_iDPI_ratio1, ($parent.Height - 65) * $g_iDPI_ratio1, 90 * $g_iDPI_ratio1, 30 * $g_iDPI_ratio1, $WS_CHILD, $WS_EX_OVERLAPPEDWINDOW, HWnd($parent.Hwnd))
