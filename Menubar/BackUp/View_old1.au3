...
Func MenubarView()
	...
	$this.AddMethod("Create", "MenubarView_Create", True)
	$this.AddMethod("Toggle", "MenubarView_Toggle", True)
	$this.AddMethod("Initialize", "MenubarView_Initialize", True)

	$this.AddProperty("Save", $ELSCOPE_PRIVATE)
	$this.AddProperty("Load", $ELSCOPE_PRIVATE)
	$this.AddProperty("Exit", $ELSCOPE_PRIVATE)
	$this.AddProperty("Canvas", $ELSCOPE_PRIVATE)
	$this.AddProperty("Parameters", $ELSCOPE_PRIVATE)
	$this.AddProperty("Script", $ELSCOPE_PRIVATE)
	$this.AddProperty("ObjectExplorer", $ELSCOPE_PRIVATE)
	$this.AddProperty("Settings", $ELSCOPE_PRIVATE)
	$this.AddProperty("About", $ELSCOPE_PRIVATE)
	$this.AddProperty("ShowGrid", $ELSCOPE_PRIVATE)
	$this.AddProperty("GridSnap", $ELSCOPE_PRIVATE)
	$this.AddProperty("PastePos", $ELSCOPE_PRIVATE)
	$this.AddProperty("ShowControl", $ELSCOPE_PRIVATE)
	$this.AddProperty("ShowHidden", $ELSCOPE_PRIVATE)
