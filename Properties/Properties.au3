...
Func Properties()
	...
	$this.AddProperty("Hwnd", $ELSCOPE_PRIVATE, Null)
...
Func Properties_Create(ByRef $this, Const $parent)
	...
	CreateButton("Background Color", 15, 165)

	GUICtrlCreateGroup("Control Colors", 10, 200, 80, 80)

	CreateButton("Background", 15, 220)

	CreateButton("Foreground", 15, 250)

	GUICtrlCreateGroup('', -99, -99, 1, 1)

	CreateButton("Cursor", 15, 285)

	CreateButton("Font", 15, 315)
