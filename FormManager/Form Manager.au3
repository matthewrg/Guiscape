...
Func FormManager()
	...
	$this.AddMethod("SetState", "FormManager_SetState")

	Return $this.Object
EndFunc   ;==>FormManager

Func FormManager_SetState(ByRef $this, Const $state)
	$this.State = $state
EndFunc
...
Func FormManager_Handler(ByRef $this, Const ByRef $event)
	...
	Return False
EndFunc   ;==>FormManager_Handler

Func FormManager_CreateHandler(ByRef $this, Const ByRef $event)

	Return False
EndFunc   ;==>FormManager_CreateHandler
